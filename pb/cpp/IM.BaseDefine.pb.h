...
inline void ContactSessionInfo::set_session_status(IM::BaseDefine::SessionStatusType value) {
  GOOGLE_DCHECK(IM::BaseDefine::SessionStatusType_IsValid(value));
...
inline void ServerUserStat::set_client_type(IM::BaseDefine::ClientType value) {
  GOOGLE_DCHECK(IM::BaseDefine::ClientType_IsValid(value));
  set_has_client_type();
  client_type_ = value;
}
...
inline void DepartInfo::set_dept_status(IM::BaseDefine::DepartmentStatusType value) {
  GOOGLE_DCHECK(IM::BaseDefine::DepartmentStatusType_IsValid(value));
  set_has_dept_status();
  dept_status_ = value;
}
