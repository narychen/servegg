...
#define log(fmt, args...) EgLog::Logi("<%s>|<%d>|<%s>--INFO--" fmt, __FILENAME__, __LINE__, __FUNCTION__, ##args)
#define logi(fmt, args...) EgLog::Logi("<%s>|<%d>|<%s>--INFO--" fmt, __FILENAME__, __LINE__, __FUNCTION__, ##args)
#else
#define log(fmt, args...)
...
#define logd(fmt, args...) EgLog::Logd("<%s>|<%d>|<%s>--DEBUG--" fmt, __FILENAME__, __LINE__, __FUNCTION__, ##args)
#else
#define logd(fmt, args...)
#endif

#ifndef NO_IM_WARN_LOG
#define logw(fmt, args...) EgLog::Logw("<%s>|<%d>|<%s>--WARN--" fmt, __FILENAME__, __LINE__, __FUNCTION__, ##args)
#else
#define logw(fmt, args...)
#endif

#ifndef NO_IM_ERROR_LOG
#define loge(fmt, args...) EgLog::Loge("<%s>|<%d>|<%s>--ERROR--" fmt, __FILENAME__, __LINE__, __FUNCTION__, ##args)
#else
#define loge(fmt, args...)
#endif

#ifndef NO_IM_TRACE_LOG
#define logt(fmt, args...) EgLog::Logt("<%s>|<%d>|<%s>--TRACE--" fmt, __FILENAME__, __LINE__, __FUNCTION__, ##args)
#else
#define logt(fmt, args...)
#endif

#ifndef NO_RUNTIME_TRACE
#define RUNTIME_TRACE EgLog::Logt("*********<%s>|<%d>|<%s>*********", __FILENAME__, __LINE__, __FUNCTION__)
#else
